package com.example.tpsdmh252_jjvrp1e2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnp1saluda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "BIENVENIDO A TOPICOS SELECTOS DE DISPOSITIVOS MOBILES" + cajanombre.getText() , Toast.LENGTH_LONG).show();
            }
        });
    }
